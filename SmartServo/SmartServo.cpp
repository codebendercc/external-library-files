...
uint8_t SmartServo::attach(int pin, int min, int max)
{
...
void SmartServo::write(int value)
{  
...
int SmartServo::read() // return the value as degrees
{
  return  map( this->readMicroseconds()+1, SERVO_MIN(), SERVO_MAX(), 0, 180);     
}

int SmartServo::readMicroseconds()
{
