/*
 ...
 waits for /change bit, then prints the status of the capacitive pads.
...
#define CHANGEPIN 2 //interrupt 0, on pin 2
#define ONEWIREPIN 3
...
void setup() {
  ...
  attachInterrupt(0, printStatus, FALLING); //change is indicated by a falling edge
}
