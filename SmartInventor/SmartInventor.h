...
/***********************************************************************/
	...
	#define TIMER0 
	#warning "not all functionality is supported for this board"
#else
	#error "Current board is not supported by SmartInventor.h library. Only atmega32 (Robolink's SmartInventor board), atmega328P (uno, leonardo, fio, ect.), and atmega2560 (mega 2560) are supported for this library."
#endif
