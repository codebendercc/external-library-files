...
LEDBar::LEDBar(int pinClock, int pinData)
{
  __pinClock = pinClock;
  __pinData = pinData;
...
void LEDBar::sendData(unsigned int data)
{
...
void LEDBar::setGreenToRed(bool greenToRed)
{
...
void LEDBar::SetLevel(float level)
{
...
// led (1-10)
// brightness (0-1)
void LEDBar::setLed(unsigned char led, float brightness)
{
...
// Toggle a single led
// led (1-10)
void LEDBar::toggleLed(unsigned char led)
{
  led = max(1, min(10, led));
...
// ........
// 11111111 brightest
void LEDBar::setData(unsigned char __state[])
{
...
void LEDBar::setBits(unsigned int bits)
{
