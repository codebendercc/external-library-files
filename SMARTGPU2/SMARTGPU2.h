...
//Arduino Board
//#define ARDUINO_DUE                 //uncomment for DUE support----------------------------

//Selected serial port for use with arduino board
#ifdef ARDUINO_DUE                  //If arduino DUE is defined
#define SERIALPORT        (Serial3) //(Serial,Serial2,Serial3)
#define ARDUINOREFERENCE   AR_DEFAULT
#else                               //Arduino UNO or similar
#define SERIALPORT        (Serial)
#define ARDUINOREFERENCE   EXTERNAL
#endif 

//SmartGPU-Arduino RESET PIN definition
#define RESET 13
