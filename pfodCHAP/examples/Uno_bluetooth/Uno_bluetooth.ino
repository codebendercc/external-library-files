/*
 ...
 this sketch is for Uno Arduino board with a bluetooth shield connected to TX/RX (Serial).  Bluetooth does not have a password
...
char currentText[] = "Hello World \xe4\xbd\xa0\xe5\xa5\xbd\xe4\xb8\x96\xe7\x95\x8c";
//{0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x57, 0x6f, 0x72, 0x6c, 0x64, 0x0a, 0xe4, 0xbd, 0xa0, 0xe5, 0xa5, 0xbd, 0xe4, 0xb8, 0x96, 0xe7, 0x95, 0x8c, 0x00};
...
void setup() {
 // Open serial communications and wait for port to open:
  ...
  parser.init(&Serial,0, F(""));  // no password, bluetooth to pfodApp does not support passwords
...
void loop() {
  ...
  if (printTimer<=0) {
    // note DO NOT call Serial.print directly as it will interfere with the msg hash when a password is used (i.e. wifi)
      ...
      // process the returns from the input screens, lists, numeric and text inputs
       ...
       switch(cmd) {
         ...
         case 'x': // return from text input
          // pickup the first arg which is the number
          // use strncpy to ensure we don't overrun the available space. the pfodApp should limit the return text
         // to the size we specified, but just in case... 
         ...
         case 'M': // return from multi selection input
          ...
          break;
   //       |.~Back to Main Screen|.~回到主画面|.~Πίσω στην κύρια οθόνη|.~メイン画面に戻る|.~Zurück zur Hauptseite Bildschirm|.~메인 화면으로 돌아|.~Обратно в главное меню}
       }   
       ...
       switch(cmd) {
          case 'a':
          /*
      //     parser.print(F("|.~Back to Main Screen|.~\xe5\x9b\x9e\xe5\x88\xb0\xe4\xb8\xbb\xe7\x94\xbb\xe9\x9d\xa2|.~\xce\xa0\xce\xaf\xcf\x83\xcf\x89 \xcf\x83\xcf\x84\xce\xb7\xce\xbd \xce\xba\xcf\x8d\xcf\x81\xce\xb9\xce\xb1 \xce\xbf\xce\xb8\xcf\x8c\xce\xbd\xce\xb7|.~\xe3\x83\xa1\xe3\x82\xa4\xe3\x83\xb3\xe7\x94\xbb\xe9\x9d\xa2\xe3\x81\xab\xe6\x88\xbb\xe3\x82\x8b|.~Zur\xc3\xbcck zur Hauptseite Bildschirm|.~\xeb\xa9\x94\xec\x9d\xb8 \xed\x99\x94\xeb\xa9\xb4\xec\x9c\xbc\xeb\xa1\x9c \xeb\x8f\x8c\xec\x95\x84|.~\xd0\x9e\xd0\xb1\xd1\x80\xd0\xb0\xd1\x82\xd0\xbd\xd0\xbe \xd0\xb2 \xd0\xb3\xd0\xbb\xd0\xb0\xd0\xb2\xd0\xbd\xd0\xbe\xd0\xb5 \xd0\xbc\xd0\xb5\xd0\xbd\xd1\x8e}"
     //      |.~Back to Main Screen"));  // for ASCII you can just use the F( ) macro to store the text in Program memeory (flash)
...
const __FlashStringHelper* demoMsgs(byte c) {
	...
	break;
            //|.~Back to Main Screen|.~Πίσω στην κύρια οθόνη|.~メイン画面に戻る|.~Zurück zur Hauptseite Bildschirm|.~메인 화면으로 돌아|.~Обратно в главное меню
        case 'a': // menus in English, Greek, Japanese, German, Korean, Russan. 
	       ...
	       "if your mobile has the font. Here are a few examples all completely controlled by the pfodDevice. "
               "|.~Back to Main Screen"
               "|.~\0316\0240\0316\0257\0317\0203\0317\0211 \0317\0203\0317\0204\0316\0267\0316\0275 \0316\0272\0317\0215\0317\0201\0316\0271\0316\0261 \0316\0277\0316\0270\0317\0214\0316\0275\0316\0267"
               "|.~\0343\0203\0241\0343\0202\0244\0343\0203\0263\0347\0224\0273\0351\0235\0242\0343\0201\0253\0346\0210\0273\0343\0202\0213"
               "|.~Zur\03031\0274ck zur Hauptseite Bildschirm"
               "|.~\0353\0251\0224\0354\0235\0270 \0355\0231\0224\0353\0251\0264\0354\0234\0274\0353\0241\0234 \0353\0217\0214\0354\0225\0204"
               "|.~\0320\0236\0320\0261\0321\0200\0320\0260\0321\0202\0320\0275\0320\0276 \0320\0262 \0320\0263\0320\0273\0320\0260\0320\0262\0320\0275\0320\0276\0320\0265 \0320\0274\0320\0265\0320\0275\0321\0216"
               "}");
        break;       
	case 'l':
		// put main msg in input array
